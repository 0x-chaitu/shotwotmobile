    ...
    return (
        <ScreenContainer style={{ paddingTop: 10, gap: 10 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <GoBackIcon style={{ marginBottom: 6, marginRight: 10 }}
            ...
            <View style={styles.imageContainer}>
                <Image style={{ height: 100, width: 100, borderRadius: 1200, }}
...
const styles = StyleSheet.create({
    container: {},
    title: {
        color: colors.palette.grey800, fontSize: 22, fontFamily: "Poppins-Medium"
    },
    imageContainer: {
        alignItems: 'center'
    },
